...
public class MCrypt {
	...
	public MCrypt() {
		this.ivspec = new javax.crypto.spec.IvParameterSpec(cl.intelidata.amicar.referencias.Texto.IV.getBytes());

		this.keyspec = new javax.crypto.spec.SecretKeySpec(cl.intelidata.amicar.referencias.Texto.KEY.getBytes(), "AES");
